...
#Taken from C-W-L/workflows/tools and modified for a single reverse and forward read fastq files. In addition secondary files 
#for reference are also added as hg19.fa does not work alone and needs index files. 
#Contributors: farahk@student.unimelb.edu.au and skanwal@student.unimelb.edu.au, University of Melbourne, Australia
...
inputs:
  - id: "#readGroupHeader"
    type: string
    default: "@RG\\tID:${sample}_${lane}\\tPL:ILLUMINA\\tPU:1\\tLB:${sample_info[sample].library}\\tSM:${sample}"
    inputBinding:
      position: 3
      prefix: "-R"
